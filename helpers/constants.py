CRISIS_PROTOCOLS = {
    "suicide_risk": {
        "text_response": "أشعر أنك تمر بألم عميق الآن، وأنا هنا لأستمع. من فضلك، إذا كنت تفكر في إيذاء نفسك، اتصل برقم الطوارئ [9999] على الفور، أو تواصل مع خط الدعم النفسي في عمان على الرقم  968 24 607 555+. المساعدة متاحة لك.",
    ...
    "acute_distress_no_direct_harm": {
        "text_response": "يبدو أنك تمر بضائقة شديدة وصعوبة بالغة. أنا هنا لأستمع وأقدم الدعم، ولكن يبدو أن هذا الموقف يتطلب دعمًا بشريًا مباشرًا. إذا كنت تشعر بالإرهاق الشديد أو أنك لا تستطيع التعامل مع مشاعرك، فكر في التواصل مع أخصائي نفسي أو طبيب. يمكنك العثور على مساعدة متخصصة من خلال  968 24 607 555.",
        "emergency_contact": "9999 (شرطة/إسعاف سلطنة عمان - للطوارئ الجسدية)",
        "mental_health_hotline": "+968 24 607 555 (Royal Hospital Psychiatry Department – Mental Health Support Line)"
    }
}
